$(function () {
  ...
  if ($("#single-restaurant").length) {
    ...
    $("#add-comment-form").submit(function (event) {
      ...
      let commentBody = $("#body-entry");
      let commentRating = $("#rating-entry");

      if (commentBody.val() == "") {
        commentBody.addClass("error")
        $("#commentErrorText").css("display", "block");
      } else if (commentRating.val() == null) {
        commentRating.addClass("error")
        $("#commentErrorText").css("display", "block");
      } else {
        $("#commentErrorText").css("display", "none");
        commentBody.removeClass("error")
        commentRating.removeClass("error")
